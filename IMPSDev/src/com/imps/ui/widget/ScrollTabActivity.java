...
public abstract class ScrollTabActivity extends Activity implements Displayable, Gesturable{
	...
	protected View.OnTouchListener contentViewTouchListener = new View.OnTouchListener(){
	    public boolean onTouch(View paramView, MotionEvent paramMotionEvent){
	        return ScrollTabActivity.this.gestureDetector.onTouchEvent(paramMotionEvent);
	    }
	};
