...
public class ServiceManager extends Service implements IConnEvent{
	...
	public static void init(){
		...
		setmTcpConn(new ConnectionService("111.186.50.164",1200));
		...
		P2PService.init("111.186.50.164",1300);
		...
		setmDoodleService(new DoodleConnectionService("111.186.50.164",1400));
	}
	...
	public static void setmReceiver(ReceiverChannelService mReceiver) {
		ServiceManager.mReceiver = mReceiver;
	}
