...
public class RtpPacketReceiver {
	...
	public RtpPacket readRtpPacket() {
		try {
			// Wait a new packet
			//System.out.println("RTPPacketReceiver:waiting for rtp packet received...port is:"+datagramConnection.getLocalPort());
			
			byte[] data = datagramConnection.receive(bufferSize);
            System.out.println("RTPPacketReceiver:"+data+": size is:"+data.length);
           // System.out.println("RTPPacketReceiver:rtp packet received...");
