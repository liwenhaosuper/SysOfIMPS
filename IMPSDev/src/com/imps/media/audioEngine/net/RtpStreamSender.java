...
import com.imps.media.audioEngine.codecs.*;
...
//			if (!Sipdroid.release) e.printStackTrace();
	...
	public void run() {
		...
		frame_rate *= 1.5;//75
		byte[] buffer = new byte[frame_size + 12];//172�ֽ�
			 ...
			 ring += frame_size;
 			 ...
 			 try {
 				udpPacket.setData(rtp_packet.packet);
 	 			...
 	 			Log.d("RtpStreamSender", "audio packet sent...dest_ip is "+dest_ip+" and port is"+dest_port);
