...
#include <stdio.h>
#include <stdlib.h>
#include "com_imps_media_video_codec_NativeH263Decoder.h"
...
/*
 * Class:     com_imps_media_video_codec_NativeH263Decoder
 * Method:    InitDecoder
 * Signature: (II)I
 */
JNIEXPORT jint JNICALL Java_com_imps_media_video_codec_NativeH263Decoder_InitDecoder
 ...
 * Signature: ()I
 */
JNIEXPORT jint JNICALL Java_com_imps_media_video_codec_NativeH263Decoder_DeinitDecoder
 ...
 * Signature: ([B[IJ)[I
 */
JNIEXPORT jint JNICALL Java_com_imps_media_video_codec_NativeH263Decoder_DecodeAndConvert
 ...
 */
JNIEXPORT jint JNICALL Java_com_imps_media_video_codec_NativeH263Decoder_InitParser
 ...
 * Signature: ()I
 */
JNIEXPORT jint JNICALL Java_com_imps_media_video_codec_NativeH263Decoder_DeinitParser
  (JNIEnv *env, jclass clazz){
	if (decoderInitialized == 1) deinitDecoder();
	parserInitialized = 0;
	return release();
 ...
 * Signature: ()I
 */
JNIEXPORT jint JNICALL Java_com_imps_media_video_codec_NativeH263Decoder_getVideoLength
  (JNIEnv *env, jclass clazz){
 ...
 * Signature: ()I
 */
JNIEXPORT jint JNICALL Java_com_imps_media_video_codec_NativeH263Decoder_getVideoWidth
  (JNIEnv *env, jclass clazz)
{
 ...
 * Signature: ()I
 */
JNIEXPORT jint JNICALL Java_com_imps_media_video_codec_NativeH263Decoder_getVideoHeight
  (JNIEnv *env, jclass clazz)
{
 ...
 */
JNIEXPORT jstring JNICALL Java_com_imps_media_video_codec_NativeH263Decoder_getVideoCoding
  (JNIEnv *env, jclass clazz)
{
 ...
 */
JNIEXPORT jobject JNICALL Java_com_imps_media_video_codec_NativeH263Decoder_getVideoSample
