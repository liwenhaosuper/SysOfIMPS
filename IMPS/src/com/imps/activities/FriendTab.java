		...
		/*friendList.setOnItemLongClickListener(new OnItemLongClickListener(){
		    public boolean onItemLongClick(AdapterView<?> arg0,View arg1,int arg2,long arg3){
		    	...
		    	if(friend!=null){
		    	    ...
		    	    String gender=friend.getGender()==0?"��":"Ů";
		    	    String status=friend.getStatus()==userStatus.OFFLINE?"����":"����";
		    	    selectedMsg = "�Ա�: "+gender+"\n����:"+friend.getEmail()+"\n״̬:"+status;
		    	    System.out.println(selectedFri);
		    	    dialog.setItems(R.array.friTab_choice, new DialogInterface.OnClickListener() {				
					@Override
					public void onClick(DialogInterface dialog, int which) {
						// TODO Auto-generated method stub
						System.out.println("������ "+getResources().getStringArray(R.array.friTab_choice)[which]);
					    switch(which)
					    {
					    case 0://��������
