...
public class RegisterUser extends Activity{
			...
			public void onClick(View arg0) {
						...
						&&eMailText.length()>0)
				{
					if(passwordText.getText().toString().equals(passwordAgainText.getText().toString()))
					{
						 ...
						 user.setGender(genderRadio.isChecked()?1:0);//1Ϊ�У�0ΪŮ
						 try {
    ...
    public class RegisterReceiver extends BroadcastReceiver{
		...
		public void onReceive(Context context, Intent intent) {
			...
			{
				Toast.makeText(RegisterUser.this,"ע��ɹ����뷵�����µ�¼��",Toast.LENGTH_SHORT).show();
				finish();
			}
    ...
    protected Dialog onCreateDialog(int id){
    	...
    	switch (id){
    	case USER_NAME:
    		b.setTitle("ע�����").setIcon(R.drawable.icon);
    		b.setMessage("�û�����Ϊ��");
    	...
    	case USEREXIST:
    		...
    		break;
    	case NET_ERROR:
    		b.setTitle("�������").setIcon(R.drawable.icon);
    		b.setMessage("��ǰ���粻�ѣ��������粢�Ժ�����");
    		b.setPositiveButton(R.string.ok, new DialogInterface.OnClickListener() {
