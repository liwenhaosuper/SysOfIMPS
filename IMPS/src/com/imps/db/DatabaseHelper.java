...
import com.imps.db.GPStracking.Media;
import com.imps.db.GPStracking.MediaColumns;
import com.imps.db.GPStracking.MetaData;
import com.imps.db.GPStracking.MetaDataColumns;
import com.imps.db.GPStracking.Segments;
import com.imps.db.GPStracking.Tracks;
import com.imps.db.GPStracking.TracksColumns;
import com.imps.db.GPStracking.Waypoints;
import com.imps.db.GPStracking.WaypointsColumns;

/**
 * Class to hold bare-metal database operations exposed as functionality blocks To be used by database adapters,
 * like a content provider, that implement a required functionality set
 */
