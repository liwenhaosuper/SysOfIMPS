...
public static abstract class Stub extends android.os.Binder implements com.imps.logger.IGPSLoggerServiceRemote
{
private static final java.lang.String DESCRIPTOR = "com.imps.logger.IGPSLoggerServiceRemote";
...
/**
 * Cast an IBinder object into an com.imps.logger.IGPSLoggerServiceRemote interface,
 * generating a proxy if needed.
 */
public static com.imps.logger.IGPSLoggerServiceRemote asInterface(android.os.IBinder obj)
{
if ((obj==null)) {
return null;
}
android.os.IInterface iin = (android.os.IInterface)obj.queryLocalInterface(DESCRIPTOR);
if (((iin!=null)&&(iin instanceof com.imps.logger.IGPSLoggerServiceRemote))) {
return ((com.imps.logger.IGPSLoggerServiceRemote)iin);
}
return new com.imps.logger.IGPSLoggerServiceRemote.Stub.Proxy(obj);
}
...
private static class Proxy implements com.imps.logger.IGPSLoggerServiceRemote
{
