...
(function($){
	$.fn.buttonCaptcha = function(userOptions) {
		var options = {
			codeWord		:	'IMPS',						// code word which must be assembled from pieces;
			codeZone		:	'com',						// if you want, you can add a domain zone to your code word (length must be from 2 to 4);
			hideButton		:	false,						// if true, then button, which you passed to the buttonCaptcha will be hidden till unlock;
			...
			captchaHeader	:	'IMPS',			// question above the Captcha;
			...
			captchaUnlocked	:	''					// text for the header of captcha when it unlocked;
		}
