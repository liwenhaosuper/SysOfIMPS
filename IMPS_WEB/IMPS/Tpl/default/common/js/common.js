// add over effect
function mouse_hover(term) {
    $(term).mouseover(function() {$(this).addClass("over");}).mouseout(function() {$(this).removeClass("over");});
}
...
function dofollow(type,target,uid){
	var html = '';
	$('#follow_state').html( '<img src="/IMPS/Tpl/default/common/images/common/icon_waiting.gif" width="15">' );
...
function dolistfollow(type,target,uid){
	...
	var target=target;
	var uid=uid;
	$("#follow_list_"+uid).html( '<img src="/IMPS/Tpl/default/common/images/common/icon_waiting.gif" width="15">' );
	$.post( U('weibo/Operate/follow') ,{uid:uid,type:type},function(txt){
		if(txt=='12'){
...
ui = window.ui ||{
	...
	emotions:function(o){
		...
		this.html = '<div class="talkPop alL" id="emotions" style="*padding-top:20px;">'
				 ...
				 + '<div class="faces_box" id="emot_content"><img src="/IMPS/Tpl/default/common/images/common/icon_waiting.gif" width="20" class="alM"></div></div></div>';
		...
		this.showContent = function(data){  //显示表情内容
			...
			$.each(data,function(i,n){
				content+='<a href="javascript:void(0)" onclick="ui.emotions_c(\''+n.emotion+'\',\''+target_set+'\')"><img src=\'/IMPS/Tpl/default/common'+'/images/expression/miniblog/'+ n.filename +'" /></a>';
			});
